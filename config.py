...
TRAILING_ACTIVATE_ATR = 0.5       # Mega Trail默认激活倍数 (0.8→0.5, P7模拟盘验证: 同信号+22 vs 实盘-66)
TRAILING_DISTANCE_ATR = 0.15      # Mega Trail默认追踪距离 (0.25→0.15, 更紧锁利)
V3_ATR_REGIME_ENABLED = True      # V3 波动率自适应: Mega Trail版 (高波动0.4/0.10, 低波动0.7/0.25)
...
STRATEGIES = {
    ...
    "m15_rsi": {
        "enabled": True,
        "name": "M15 RSI均值回归",
        "max_hold_bars": 4,       # ~4小时, 回测M15引擎max_hold=15根M15≈3.75h, 此处用H1 bars单位
    },
    "gap_fill": {
