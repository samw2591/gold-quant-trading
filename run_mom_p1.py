#!/usr/bin/env python3
"""Part 1: Baseline + Individual bypass (A-D) — 4 variants"""
import sys, os, time
...
VARIANTS = [
    ("A: Baseline", "none", "neutral", {}),
    ("B: KC bypass", "kc", "neutral", {}),
    ("C: ATR spike bypass", "atr", "neutral", {}),
    ("D: Price mom bypass", "mom", "neutral", {}),
]

results = []
for label, bm, ut, bp in VARIANTS:
    if bm != "none":
    ...
    stats = run_variant(data, label, **CURRENT)
    BacktestEngine._update_intraday_score = _original_update
